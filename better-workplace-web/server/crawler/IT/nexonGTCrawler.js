...
export default class nexonGTCrawler {
	constructor() {
		this.company = 'nexonGT';
		this.name = '넥슨GT';
		this.links = [];
		this.url = 'https://career.nexon.com/user/recruit/notice/noticeList?joinCorp=GH';
	...
	executeCrawling(url) {
		...
		driver.wait(until.titleContains('넥슨지티'), 5000).catch((err) => {
			return;
		});
		let that = this;
