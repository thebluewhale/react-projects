...
export default class neopleCrawler {
	constructor() {
		this.company = 'neople';
		this.name = '네오플';
		this.links = [];
		this.url = 'https://career.nexon.com/user/recruit/notice/noticeList?joinCorp=NO';
	...
	executeCrawling(url) {
		...
		driver.wait(until.titleContains('네오플'), 5000).catch((err) => {
			return;
		});
		let that = this;
