...
export default class daewooShipbuildingCrawler {
	constructor() {
		this.company = 'daewooShipbuilding';
		this.name = '대우조선해양';
		this.links = [];
		this.url = 'http://recruit.dsme.co.kr/recruit/fr/main.do#?RightMenuId=RL&ApplyStep=&CurrentRrNo=&CurrentCourseCode=&CurrentTopIndex=';
